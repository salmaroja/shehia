...
function Dashboard() {
  ...
  const handleImportantLocations = () => {
    ...
    // Implement logic to fetch and display locations
  };
  ...
  const handleReports = () => {
    ...
    // Implement logic to fetch and display reports
  };

  const handleServices = () => {
    setShowServices(!showServices);
    // Implement logic to fetch and display services
  };

  const handleFinance = () => {
    setShowFinance(!showFinance);
    // Implement logic to fetch and display finance information
  };
            ...
            <div className="card-body">
              ...
              {showFinance && (
                <ul className="mt-3">
                  ...
                  {/* Add more financial management details as needed */}
                </ul>
              )}
            </div>
          </div>
